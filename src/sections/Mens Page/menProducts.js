...
export const menProducts = [
  {
    ...
    sizes: [],
    images:[
      "/images/mens/products/A11946_25Q3_Runner-NZ-Corduroy-Dark-Tan-Stony-Cream-Sole_PDP_LEFT__1.png",
      "/images/mens/products/A11946_25Q3_Runner-NZ-Corduroy-Dark-Tan-Stony-Cream-Sole_PDP_BACK.png",
     " /images/mens/products/A11946_25Q3_Runner-NZ-Corduroy-Dark-Tan-Stony-Cream-Sole_PDP_TD.png"
    ],
  ...
  },
  {
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/A10995_24Q4_Runner-Protect-Dark-Grey-Medium-Grey_PDP_LEFT__1_37e926eb-9007-4be0-bb92-d7a5f7e3e567.png?v=1751060054&width=1024",
    ...
    description:"The Runner NZ Corduroy is a seasonal update to our classic Tree Runner, crafted with soft corduroy fabric made from recycled plastic bottles."
    
  },
  {
    id: 5,
    label: "New",
    product_name: "MEN'S SUPERLIGHT TR",
    subtitle: "Dark Tan",
    price: 120,
    variants: [
      {
    ...
    extraColors: 0,
    sizes: [],
    images:["	https://www.allbirds.com/cdn/shop/files/TR3MMST080…2fc-aef3-7d6093c605bf.png?v=1751166590&width=1024",
  ...
  },
  {
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/A11814_25Q4_Tree-Dasher-2-Natural-Black-Royal-Blue-Blizzard-Sole_PDP_LEFT.png?v=1758327119&width=1024",
    ...
    description:"The Wool Cruiser Slip-On is a convenient and comfortable sneaker made with sustainable materials, perfect for on-the-go wear."  
  },
  {
    id: 7,
    label: "New",
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/TP1MMOO_TR…240-9f3b-d888fb001faa.png?v=1751165148&width=1024",
    ...
    description:"The Strider is a versatile sneaker designed for all-day comfort, featuring a breathable knit upper and our signature Tree™ sole."
  },
  {
    id: 8,
    label: "New",
    ...
    description:"The Canvas Piper is a casual sneaker made with sustainable materials, designed for everyday wear with a comfortable fit and timeless style."
  }
  ,{
    id: 9,
    label: "Bestseller",
    product_name: "MEN'S CRUISER MID EXPLOREER",
    subtitle: "Dark Tan",
    price: 110,
    variants: [
      {
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/A11853_25Q3_Cruiser-Mid-Explore-Rustic-Green-Hazy-Beige_PDP_LEFT_161a7d72-a755-49cc-b977-31305c32594b.png?v=1758235530&width=1024",
  ...
  description:"The Cruiser mid explorer is a casual sneaker made with sustainable materials, designed for everyday wear with a comfortable fit and timeless style."
  },
  {
    id: 10,
    label: "New",
    product_name: "RECYCLED SHOE BAG",
    subtitle: "Dark Tan",
    price: 60,
    variants: [
      {
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/A11546_24Q4_Recycled_Shoe_Bag_Twilight_Teal_PDP_Front_25106-1300x1300.png?v=1731027696&width=1024",
    ...
    description:"The Allbirds recycled shoe bag is made from 100% recycled materials, providing a sustainable and stylish way to carry your shoes on the go.",
  }
  ,
   {
    id: 11,
    label: "New",
    product_name: "MEN'S TRAIL RUNNER",
    subtitle: "Dark Tan",
    price: 60,
    variants: [
      {
    ...
    extraColors: 0,
    sizes: [],
    images:["https://www.allbirds.com/cdn/shop/files/A11428_25Q1_Trail_Runner_SWT_Weathered_White_Weathered_Grey_PDP_LEFT-2000x2000.png?v=1750995429&width=1024",
